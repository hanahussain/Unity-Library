...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Event Volunteer Results)</title>
            ...
            <section class="service">
				<div class="container">
					<div class="service-details">
                        <div style="width: 300px;" class="input-box">
                            <p style="margin-bottom: 10px; margin-left:10px">Thank you for volunteering for event!</p>
                            <h2 class="user-registration">Event Information</h2>
                            <div style="margin-left: 20px">
                                <p>Event: <?php print $event; ?></p>
								<p>Hours to Volunteer: <?php print $hours; ?></p>
								<a href="volunteerDashboard.php" style="color:white" class="submit-button-modified">Back to Volunteer Dashboard</a>
                            </div>
