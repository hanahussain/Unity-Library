...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Book Results)</title>
...
<body>
    <?php
        ...
        $tagsList = $_SESSION['tagsList'];
        $genre = $_SESSION['genre'];
        $numberCopies = $_SESSION['numberCopies'];
				...
				<div class="container">
					<div class="service-details">
                        <div style="width: 500px;" class="input-box">
                            <h2 class="user-registration">Book Information</h2>
                            ...
                            <div style="margin-left: 20px">
                                ...
                                <p>Age Range: <?php print $ageRange; ?></p>
                                <p>Number of Copies: <?php print $numberCopies; ?></p>
                                <p>Genre: <?php print $genre; ?></p>  
                                <p>Tags: <?php foreach ($tagsList as $element) {print $element . ", ";} ?></p>  
                                <p>Books Added: <?php foreach ($booksList as $element) {print $element . ", ";}  ?></p> 
