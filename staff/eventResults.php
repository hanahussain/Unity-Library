...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Event Results)</title>
...
<body>
    <?php
        ...
        $date = $_SESSION['date'];
        $numberAttendees = $_SESSION['numberAttendees'];
        $numberVolunteers = $_SESSION['numberVolunteers'];
            ...
            <section class="service">
				<div class="container">
					<div class="service-details">
                        <div style="width: 500px;" class="input-box">
                            <h2 class="user-registration">Event Information</h2>
                            ...
                            <div style="margin-left: 20px">
                                <p>Event Name: <?php print $name; ?></p>
                                <p>Event Description: <?php print $description; ?></p>
                                <p>Event Date: <?php print $date; ?></p>
                                <p>Number of Attendees: <?php print $numberAttendees; ?></p>
                                <p>Number of Volunteers: <?php print $numberVolunteers; ?></p>  
                                <p>EventList: <?php foreach ($eventList as $element) {print $element . ", ";} ?></p>  
								<a href="staff.php" style="color:white" class="submit-button-modified">Back to Staff Dashboard</a>
                            </div>
