...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Staff Dashboard)</title>
...
<body>
    <?php
        ...
        // Only show this message when staff first registers
        if (isset($_GET['role'])) {
            $message = "<p style=\"margin-left: 10px; margin-bottom: 10px;\">Successfully registered as staff!</p>";
        }
        session_start();
    ?>
				...
				<div class="container">
					<div class="service-details">
                        <div style="width: 390px; padding: 30px;" class="input-box">
			                ...
			                ?>
                            <h2 style="margin-bottom: -10px" class="user-registration">Staff Dashboard</h2>
                            <div style="margin-left: 20px">
                                <div style="display: flex">
                                <a href="book.php" style="color:white" class="submit-button-modified">Add New Book</a>
                                </div>
                                <a href="event.php" style="color:white" class="submit-button-modified">Add New Event</a> 
