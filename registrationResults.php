...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Registration Results)</title>
				...
				<div class="container">
					<div class="service-details">
                        <div style="width: 400px;" class="input-box">
                            <p style="margin-left: 10px; margin-bottom: 10px;">Successfully registered user!</p>
                            <h2 class="user-registration">Registration Information</h2>
                            ...
                            <div style="margin-left: 20px">
                                ...
                                <p>Role in Library: <?php print $role; ?></p>
								<button type="submit" style="width: 300px; margin-top: 10px" class="submit-button" value="dashboard" name="dashboard">Go to Dashboard</button>
                            </div>
