...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Book Checkout)</title>
...
<body>
    <?php
        ...
        if(isset($_POST['checkoutBook'])){
			...
			header('Location: bookCheckoutResults.php');
        } // end register post
    ?>
            ...
            <section class="service">
				<div class="container">
					<div class="service-details">
                        <div style="width:350px" class="input-box">
                            <h2 class="user-registration">Checkout Book</h2>
							    <div>
									<label for="dropdown" style="margin-left:20px">Select book to checkout:</label>
									<select id="dropdown" name="book" style="width: 200px; padding: 5px; border-radius: 10px; margin-left: 20px;" required>
                                ...
                                <button type="submit" style="margin-top: 15px; margin-left: 15px; margin-right: 15px; margin-bottom: -15px; width: 250px;" class="submit-button" value="checkoutBook" name="checkoutBook">Checkout Book</button>			
                            </div>
