...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Member Dashboard)</title>
				...
				<div class="container">
					<div class="service-details">
                        <div style="width: 390px; padding: 30px;" class="input-box">
			                ...
			                ?>
                            <h2 style="margin-bottom: -10px" class="user-registration">Member Dashboard</h2>
                            <div style="margin-left: 20px">
                                <div style="display: flex">
                                <a href="bookCheckout.php" style="color:white" class="submit-button-modified">Checkout Book</a>
                                </div>
                                <a href="bookReview.php" style="color:white" class="submit-button-modified">Give a Book a Review</a> 
								<a href="eventAttend.php" style="color:white" class="submit-button-modified">Register for Event</a> 
                                <?php
									if ($role != "volunteer") {
										print '<a href="volunteer.php" style="color:white" class="submit-button-modified">Sign up to be Volunteer</a>';
									} else {
										print '<a href="../volunteer/volunteerDashboard.php" style="color:white" class="submit-button-modified">Back to Volunteer Dashboard</a>';
									}
								?> 
