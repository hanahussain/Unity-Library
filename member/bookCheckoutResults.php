...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Book Checkout Results)</title>
				...
				<div class="container">
					<div class="service-details">
                        <div style="width: 300px;" class="input-box">
                            <p style="margin-bottom: 10px; margin-left:10px">Thank you for checking out a book!</p>
                            <h2 class="user-registration">Book Information</h2>
                            <div style="margin-left: 20px">
                                <p>Title: <?php print $book; ?></p>
                                <p>Due Date: <?php print $date; ?></p>
								<a href="member.php" style="color:white" class="submit-button-modified">Back to Member Dashboard</a>
                            </div>
