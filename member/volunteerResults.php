...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Volunteer Results)</title>
...
<body>
    <?php
        ...
        $volunteerHours = $_SESSION['volunteerHours'];
        ...
        if(isset($_POST['dashboard'])){
            if($role == "member"){
                ...
                header('Location: ../volunteer/volunteerDashboard.php');
            } else {
				...
				<div class="container">
					<div class="service-details">
                        <div style="width: 400px;" class="input-box">
                            <p style="margin-left: 10px; margin-bottom: 10px;">Successfully signed volunteer up!</p>
                            <h2 class="user-registration">Volunteer Information</h2>
                            <div style="margin-left: 20px">
                                <p>First Name: <?php print $first; ?></p>
                                <p>Last Name: <?php print $last; ?></p>
                                <p>Email: <?php print $email; ?></p>
                                <p>Hours Volunteered: <?php print $volunteerHours; ?></p>
								<button type="submit" style="width: 300px; margin-top: 10px" class="submit-button" value="dashboard" name="dashboard">Go to Volunteer Dashboard</button>
                            </div>
