...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Attend Event)</title>
...
<body>
    <?php
        ...
        if(isset($_POST['eventAttend'])){
			...
			header('Location: eventAttendResults.php');
        } // end register post
    ?>
            ...
            <section class="service">
				<div class="container">
					<div class="service-details">
                        <div style="width:330px" class="input-box">
                            <h2 class="user-registration">Attend Event</h2>
							    <div>
									<label for="dropdown" style="margin-left:20px">Select event you'd like to register to attend:</label>
                                ...
                                <button type="submit" style="margin-top: 15px; margin-left: 15px; margin-right: 15px; margin-bottom: -15px; width: 250px;" class="submit-button" value="eventAttend" name="eventAttend">Attend Event</button>			
                            </div>
