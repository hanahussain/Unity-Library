...
<head>
    ...
    <!-- TITLE OF SITE -->
    <title>Unity Library (Event Attend Results)</title>
				...
				<div class="container">
					<div class="service-details">
                        <div style="width: 300px;" class="input-box">
                            <p style="margin-bottom: 10px; margin-left:10px">Thank you for registering to attend event!</p>
